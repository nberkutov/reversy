...
public class GameController {
    ...
    public static void actionMovePlayer(final MovePlayerRequest movePlayer, final ClientConnection connection)
    ...
    public static void actionGetReplayGame(final GetReplayGameRequest getGame, final ClientConnection connection)
            throws IOException, ServerException {
    ...
    public static void actionCreateGame(final ClientConnection firstConnection, final ClientConnection secondConnection)
            throws IOException, ServerException {
    ...
    public static void sendInfoAboutGame(final Game game, final User user) throws IOException {
        try {
            final ClientConnection connection = PlayerService.getConnectionByPlayer(user);
    ...
    private static void sendResponse(final ClientConnection connection, final GameResponse response)
            throws IOException, ServerException {
