...
public class ClientBoardLogic {
     ...
     * @return Set<Point>
     */
    private static Set<Point> getPointsForReverse(final Point point, final Point target) {
        //checkPointIsInside(point);
    ...
    /**
     * Функция, которая находит в одном направлениях ближайшую одинаковую фишку,
     * чтоб потом найти промежуточные фишки и их перевернуть
     *
     * @param board - Игровое поле
     * @param cell  - цвец фишки
     * @return Point
